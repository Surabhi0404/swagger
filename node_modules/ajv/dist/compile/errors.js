...
function extendErrors({ gen, keyword, schemaValue, data, errsCount, it, }) {
    ...
    gen.forRange("i", errsCount, names_1.default.errors, (i) => {
        ...
        gen.if(codegen_1._ `${err}.dataPath === undefined`, () => gen.assign(codegen_1._ `${err}.dataPath`, codegen_1._ `${codegen_1.strConcat(names_1.default.dataPath, it.errorPath)}`));
        gen.assign(codegen_1._ `${err}.schemaPath`, codegen_1._ `${codegen_1.str `${it.errSchemaPath}/${keyword}`}`);
        if (it.opts.verbose) {
